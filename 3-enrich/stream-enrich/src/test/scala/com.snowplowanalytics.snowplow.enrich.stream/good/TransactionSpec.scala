...
object TransactionSpec {
  ...
  val pii = List[StringOrRegex](
    ...
    "",
    "",
    """{"schema":"iglu:com.snowplowanalytics.snowplow/unstruct_event/jsonschema/1-0-0","data":{"schema":"iglu:com.snowplowanalytics.snowplow/pii_transformation/jsonschema/1-0-0","data":{"pii":{"pojo":[{"fieldName":"user_ipaddress","originalValue":"10.0.2.x","modifiedValue":"7135f2790b847ec9ec865f669b00b0a97ac33ad0"},{"fieldName":"user_id","originalValue":"alex 123","modifiedValue":"9a8418f7ec966d75e207a407c9def52c46f391e4"}]},"strategy":{"pseudonymize":{"hashFunction":"SHA-1"}}}}}""",
    "",
    "",
    "",
    "",
